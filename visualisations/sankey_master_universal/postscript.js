...
(function (global) {
  ...
  function ensureUi(gd, YEARS, setYears) {
    ...
    if (!document.getElementById('save_svg_btn')) {
      ...
      btn.id = 'save_svg_btn';
      btn.textContent = 'Save to SVG';
      btn.style.padding = '8px 12px';
      btn.style.border = '2px solid #007cba';
      ...
      btn.onmouseover = function() {
        ...
        this.style.boxShadow = '0 4px 8px rgba(0,124,186,0.3)';
      };
      ...
      btn.onclick = function () {
        if (window.Plotly && gd) {
          ...
          // Use Plotly's downloadImage with proper SVG settings
